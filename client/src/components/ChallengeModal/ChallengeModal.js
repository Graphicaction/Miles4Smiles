...
function ChallengeModal(props) {
  return (
    ...
    <>
      <button type="button" className="btn start-challenge" data-toggle="modal" data-target="#challengeModal"><i className="fa fa-flag-checkered mr-2"/>Challenge a User</button>
