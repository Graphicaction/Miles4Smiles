  ...
  return(
    ...
    <div key={user.username} className="card text-center">
      <div key={user._id.toString()} className="card-body ">
        ...
        <hr></hr>
        <p  className="card-text pace">Average pace: {user.averagePace.toString()} min/mile</p>
        <p  className="card-text distance">Preferred distance: {user.averageDistance.toString()} miles</p>
        <hr></hr>
